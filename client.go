...
func NewClient(options ClientOptions) *Client {
	...
	client.FormTask = &formTaskApi{client: client}
...
func (c *Client) doPostBody(path string, body io.Reader, query map[string]string) (res *http.Response, err error) {
